...
vim.keymap.set({ 'v','n' }, '<C-x>', ':bdelete!<CR>', { noremap = true, silent = true, desc = "Next buffer" })
vim.keymap.set('i', '<C-x>', '<Esc>:bdelete!<CR>', { noremap = true, silent = true, desc = "Next buffer" })
...
vim.keymap.set({ 'v', 'n' }, '<C-h>', ':wincmd h<CR>', { noremap = true, silent = true, desc = "Left window" })
vim.keymap.set({ 'v', 'n' }, '<C-l>', ':wincmd l<CR>', { noremap = true, silent = true, desc = "Right window" })
vim.keymap.set({ 'v', 'n' }, '<C-right>', ':bn!<CR>', { noremap = true, silent = true, desc = "Next buffer" })
vim.keymap.set({ 'v', 'n' }, '<M-f>', ':bn!<CR>', { noremap = true, silent = true, desc = "Next buffer" })
vim.keymap.set({ 'v', 'n' }, '<C-left>', ':bp!<CR>', { noremap = true, silent = true, desc = "Previous buffer" })
vim.keymap.set({ 'v', 'n' }, '<M-b>', ':bp!<CR>', { noremap = true, silent = true, desc = "Previous buffer" })
vim.keymap.set({ 'n', 'v' }, '<leader>w<up>', ':wincmd k<CR>', { noremap = true, silent = true, desc = "Top window" })
vim.keymap.set({ 'n', 'v'}, '<leader>w<down>', ':wincmd j<CR>', { noremap = true, silent = true, desc = "Bottom window" })
vim.keymap.set({ 'n', 'v'}, '<leader>w<left>', ':wincmd h<CR>', { noremap = true, silent = true, desc = "Left window" })
vim.keymap.set({ 'n', 'v'}, '<leader>w<right>', ':wincmd l<CR>', { noremap = true, silent = true, desc = "Right window" })
vim.keymap.set({ 'n', 'v'}, '<leader>wk', ':wincmd k<CR>', { noremap = true, silent = true, desc = "Top window" })
vim.keymap.set({ 'n', 'v'}, '<leader>wj', ':wincmd j<CR>', { noremap = true, silent = true, desc = "Bottom window" })
vim.keymap.set({ 'n', 'v'}, '<leader>wh', ':wincmd h<CR>', { noremap = true, silent = true, desc = "Left window" })
vim.keymap.set({ 'n', 'v'}, '<leader>wl', ':wincmd l<CR>', { noremap = true, silent = true, desc = "Right window" })
vim.keymap.set({ 'v', 'n'}, '<C-к>', ':wincmd k<CR>', { noremap = true, silent = true, desc = "Top window" })
vim.keymap.set({ 'v', 'n'}, '<C-й>', ':wincmd j<CR>', { noremap = true, silent = true, desc = "Bottom window" })
vim.keymap.set({ 'v', 'n'}, '<C-х>', ':wincmd h<CR>', { noremap = true, silent = true, desc = "Left window" })
vim.keymap.set({ 'v', 'n'}, '<C-л>', ':wincmd l<CR>', { noremap = true, silent = true, desc = "Right window" })
vim.keymap.set({ 'v', 'n'}, '<leader>в<up>', ':wincmd k<CR>', { noremap = true, silent = true, desc = "Top window" })
vim.keymap.set({ 'v', 'n'}, '<leader>в<down>', ':wincmd j<CR>', { noremap = true, silent = true, desc = "Bottom window" })
vim.keymap.set({ 'v', 'n'}, '<leader>в<left>', ':wincmd h<CR>', { noremap = true, silent = true, desc = "Left window" })
vim.keymap.set({ 'v', 'n'}, '<leader>в<right>', ':wincmd l<CR>', { noremap = true, silent = true, desc = "Right window" })
vim.keymap.set({ 'v', 'n'}, '<leader>вк', ':wincmd k<CR>', { noremap = true, silent = true, desc = "Top window" })
vim.keymap.set({ 'v', 'n'}, '<leader>вй', ':wincmd j<CR>', { noremap = true, silent = true, desc = "Bottom window" })
vim.keymap.set({ 'v', 'n'}, '<leader>вх', ':wincmd h<CR>', { noremap = true, silent = true, desc = "Left window" })
vim.keymap.set({ 'v', 'n'}, '<leader>вл', ':wincmd l<CR>', { noremap = true, silent = true, desc = "Right window" })
-- terminal
